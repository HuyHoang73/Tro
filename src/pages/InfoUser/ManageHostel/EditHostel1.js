...
export default function EditHostel1(props) {
  ...
  const onFinish = (values) => {
    ...
    const fetchApi = async () => {
      const result = await editHostel(item.id, finalValues);
      if (result) {
        onReload();
        setIsModalOpen(false);
        swal({
          ...
          <div className="hostel-modal-form">
            ...
            >
              ...
              <Form.Item
                ...
                initialValue={item.address.slice(0, 3)}
              >
                <Cascader
                  options={residences}
                  value={item.address.slice(0, 3)}
                />
              </Form.Item>
              ...
              <Form.Item
                ...
                initialValue={item.address[3]}
              >
                <Input style={{ color: "black" }} value={item.address[3]} />
              </Form.Item>
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  <Form.Item
                    ...
                    initialValue={item.acreage}
                  >
                    <InputNumber min={1} max={500} style={{ color: "black" }} />
                  </Form.Item>
                </div>
              </div>
              ...
              >
                <div style={{ flex: 1, marginRight: "8px" }}>
                  <Form.Item
                    ...
                    initialValue={item.functionroom[0]}
                  >
                ...
                <div style={{ flex: 1 }}>
                  <Form.Item
                    ...
                    initialValue={item.functionroom[1]}
                  >
                    <InputNumber min={1} max={10} />
                  </Form.Item>
                </div>
                <div style={{ flex: 1 }}>
                  <Form.Item
                    ...
                    initialValue={item.functionroom[2]}
                  >
                    <InputNumber min={1} max={10} />
                  </Form.Item>
                </div>
              ...
              >
                <div style={{ flex: 1, marginRight: "8px" }}>
                  ...
                  >
                    <InputNumber min={1} max={200} value={item.room} />
                  </Form.Item>
                </div>
                <div style={{ flex: 1 }}>
                  <Form.Item
              ...
              >
                <TextArea rows={4} style={{ color: "black" }} />
              </Form.Item>
